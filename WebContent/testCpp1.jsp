...
<body>
	...
	<input type="hidden" name="courname" value="<%=courname %>" />
		<table width="806" border="0">
			...
			<tr>
				<td colspan="3" bgcolor="#CCCCCC"><div align="right" /> <strong>一、单项选择题：（每题5分，共60分）</strong></td>
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
			...
			<tr>
				<td height="201">&nbsp;</td>
				<td><img src="image/cpp1.png" width="294" height="180" alt="" /></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			...
			<tr>
				<td>&nbsp;</td>
				<td>3.以下叙述中不属于面向对象特点的是（ ）。</td>
				<td>&nbsp;</td>
			</tr>

			<tr>
				<td>&nbsp;</td>
				<td><label> A. 封装性 <input type="radio" name="radio2"
						id="radio" value="A" /> &nbsp; B. 宏定义 <input type="radio"
						name="radio2" id="radio" value="B" /> &nbsp; C. 多态性 <input
						type="radio" name="radio2" id="radio" value="C" /> &nbsp; D. 继承性
						<input type="radio" name="radio2" id="radio" value="D" /></label></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			...
			<tr>
				<td>&nbsp;</td>
				<td>6.C++中int型常变量MAX_LENGTH，值保持为常数100，则定义这个变量的语句是（ ）。</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>A. public int MAX_LENGTH＝100;<input type="radio"
					name="radio5" id="radio" value="A" /><br /> B. const int
					MAX_LENGTH＝100; <input type="radio" name="radio5" id="radio"
					value="B" /><br /> C. const int&amp; MAX_LENGTH＝100; <input
					type="radio" name="radio5" id="radio" value="C" /><br /> D. final
					int MAX_LENGTH＝100; <input type="radio" name="radio5" id="radio"
					value="D" /></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3" bgcolor="#CCCCCC"><a name="A2" id="A2" /><strong>二、基本操作题（共18分）</strong></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				<td>&nbsp;</td>
				<td>7.本题中定义了一个长度为20的整数数组，然后将1～20分别赋给数组元素，计算该数组中所有下标为奇数的元素的和。</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><img src="image/41.png" width="565" height="365" alt="" /></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
			...
			<tr>
				<td colspan="3" bgcolor="#CCCCCC"><a name="A3" id="A3" />三、<strong>简单应用题（共22分）</strong></td>
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>8.本题是－个Applet，页面中有10个按钮，名称从“0～9”，用鼠标任意单击其中－个按钮后，通过键盘上的上下左右键可以控制按钮在窗口中移动。</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><p>
						<img src="image/8_1.png" width="596" height="307" alt="" />
					</p>
					<p>
						<img src="image/8_2.png" width="593" height="623" alt="" />
					</p></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
